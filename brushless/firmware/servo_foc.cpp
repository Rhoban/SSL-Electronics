...
#define VOLTAGE_P_SCALE 1048576
#define LIMITED_SPEED_ERROR_SCALE 16777216
#define SPEED_ERROR_SCALE 16777216
...
void control_with_vectorial_command(){
    ...
    if( motor_is_tared() and motor_foc_is_on() ){
        ...
        if(!manual_speed){
            ...
            limited_theta_error = ( (theta_error > 19660) ? 19660 : ( (theta_error < -19660) ? -19660 : theta_error ) );
            speed_p = ((limited_theta_error/1)*(k_pos_p/16384));
            speed_load = ((((limited_theta_error/1)*(k_pos_i/16384))/32768)*((1789569)/64));
        ...
        // begin of automatic code - generated by integer_calculus.py
        speed_error = ((-speed)*16 + speed_c/4);
        limited_speed_error = ( (speed_error > 50331648) ? 50331648 : ( (speed_error < -50331648) ? -50331648 : speed_error ) );
        voltage_p = ((limited_speed_error/2048)*(k_speed_p/32768));
        voltage_load = ((((limited_speed_error/1024)*(k_speed_i/65536))/32768)*((1789569)/64));
        ...
        electromagnetic_force = ((speed/2048)*(k_fem/32768));
...
TERMINAL_COMMAND(kpp, "Set P for position PID")
{
    if (argc == 1) {
        ...
        if(k_pos_p_input > 16.666666666666668) k_pos_p_input = 16.666666666666668;
        ...
        terminal_io()->println("Usage: kpp [0.0 - 6.66]");
    }
}
TERMINAL_COMMAND(kpi, "Set I for position PID")
{
    if (argc == 1) {
        ...
        if(k_pos_i_input > 166.6666666666666) k_pos_i_input = 166.6666666666666;
        ...
        terminal_io()->println("Usage: kpi [0.0 - 66.66]");
    }
}
TERMINAL_COMMAND(ksp, "Set P for speed PID")
{
    if (argc == 1) {
        ...
        if(k_speed_p_input > 341.3333333333333) k_speed_p_input = 341.3333333333333;
        ...
        terminal_io()->println("Usage: ksp [ 0.0 - 512.0 ]");
    }
}
TERMINAL_COMMAND(ksi, "Set I for speed PID")
{
    if (argc == 1) {
        ...
        if(k_speed_i_input > 3413.333333333333) k_speed_i_input = 3413.333333333333;
        ...
        terminal_io()->println("Usage: ksi [ 0.0 - 5120.0 ]");
    }
}
TERMINAL_COMMAND(kem, "Set I for speed PID")
{
    if (argc == 1) {
        ...
        if(k_fem_input > 102.4) k_fem_input = 102.4;
        ...
        terminal_io()->println("Usage: kem [ 0.0 - 93.09 ]");
    }
}

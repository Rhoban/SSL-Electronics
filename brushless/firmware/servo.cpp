...
int voltage_i = 0;
int k_speed_i = 0;
int k_fem = KFEM*33554432;
// end of automatic code - generated by integer_calculus.py

int output_voltage_d = 0;
// begin of automatic code - generated by integer_calculus.py
int output_voltage_q = 0;
...
void control_with_vectorial_command(){
    ...
    if( motor_is_tared() ){
        ...
        voltage_load = ((((limited_speed_error/1024)*(k_speed_i/4096))/65536)*((715827)/16));
        voltage_i__acc_sum = (voltage_i/1 + voltage_load/8388608);
        ...
        voltage_q = ((electromagnetic_force/1 + voltage_i/4)/2 + voltage_p/8);
...
TERMINAL_COMMAND(kpp, "Set P for position PID")
{
    if (argc == 1) {
        ...
        if(argc==0){
            terminal_io()->println(((double)k_pos_p)/536870912);
            return;
        }
...
TERMINAL_COMMAND(kpi, "Set I for position PID")
{
    if (argc == 1) {
        ...
        if(argc==0){
            terminal_io()->println(((double)k_pos_i)/2147483648);
            return;
        }
...
TERMINAL_COMMAND(ksi, "Set I for speed PID")
{
    if (argc == 1) {
        ...
        if(argc==0){
            terminal_io()->println(((double)k_speed_i)/2147483648);
            return;
        }
...
TERMINAL_COMMAND(kem, "Set I for speed PID")
{
    if (argc == 1) {
        ...
        if(argc==0){
            terminal_io()->println(((double)k_fem)/33554432);
            return;
        }
...
TERMINAL_COMMAND(speed_csg, "Set speed consign")
{
    if (argc == 1) {
        ...
        if(speed_csg_input < -40.0) speed_csg_input = -40.0;
        if(speed_csg_input > 40.0) speed_csg_input = 40.0;
        speed_csg = (int) (speed_csg_input * 33554432);
        // end of automatic code - generated by integer_calculus.py
    } else {
        if(argc==0){
            terminal_io()->println((double)speed_csg/33554432);
            return;
        }
        terminal_io()->println("Usage: speed_csg [ -40.0 - 40.0 ]");
    }
}

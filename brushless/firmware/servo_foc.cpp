...
#define K_POS_P_SCALE 268435456
...
void control_with_vectorial_command(){
    ...
    if( motor_is_tared() and motor_foc_is_on() ){
        ...
        if(!manual_speed){
            ...
            limited_theta_error = ( (theta_error > 49152) ? 49152 : ( (theta_error < -49152) ? -49152 : theta_error ) );
            speed_p = ((limited_theta_error/1)*(k_pos_p/65536));
            speed_load = ((((limited_theta_error/1)*(k_pos_i/32768))/32768)*((1789569)/64));
        ...
        voltage_load = ((((limited_speed_error/1024)*(k_speed_i/32768))/32768)*((1789569)/64));
...
TERMINAL_COMMAND(kpp, "Set P for position PID")
{
    if (argc == 1) {
        ...
        if(k_pos_p_input > 6.66666666666666) k_pos_p_input = 6.66666666666666;
...
TERMINAL_COMMAND(kpi, "Set I for position PID")
{
    if (argc == 1) {
        ...
        if(k_pos_i_input > 66.66666666666666) k_pos_i_input = 66.66666666666666;
...
TERMINAL_COMMAND(ksp, "Set P for speed PID")
{
    if (argc == 1) {
        ...
        if(k_speed_p_input > 512.0) k_speed_p_input = 512.0;
...
TERMINAL_COMMAND(ksi, "Set I for speed PID")
{
    if (argc == 1) {
        ...
        if(k_speed_i_input > 5120.0) k_speed_i_input = 5120.0;
